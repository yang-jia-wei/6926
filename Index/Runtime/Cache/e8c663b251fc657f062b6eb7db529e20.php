...
<nav class="breadcrumb"><a title="返回首页" href="index.php" data-wpel-link="internal">首页</a> &gt; <a href="" data-wpel-link="internal"><?php $classify=M('classify')->where(array('classify_id'=>209))->find();echo $classify['classify_name'];?></a> &gt;  文章 </nav><div id="content" class="site-content" style="transform: none;">
    <div class="clear"></div>
    ...
    <section id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            <div id="post_list_box" class="border_gray">
                <?php $perpage=11;$offset=($p-1)*$perpage; $gossip = M()->table('index_gossip n,index_relevance r')->where('r.classify_id ='.$classify_id.' and r.content_id=n.gossip_id')->order('date desc')->limit($offset,$perpage)->select(); $total_num=M()->table('index_gossip n,index_relevance r')->where('r.classify_id ='.$classify_id.' and r.content_id=n.gossip_id')->count(); foreach($gossip as $k=>$v){ ?>
                    <article id="post-41145" class="archive-list">
                        <figure class="thumbnail box-hide">
                            <a href="http://www.puawm.com/41145" data-wpel-link="internal"><img src="<?php echo $v['gossip_pic'];?>" alt="<?php echo $v['gossip_title'];?>"></a>
                        </figure>
                        <header class="entry-header">
                            <h2 class="entry-title"><a href="<?php echo content_url($v['type_id'],$v['gossip_id'])?>" target="_blank" data-wpel-link="internal"><?php echo $v['gossip_title'];?></a></h2>
                        </header><!-- .entry-header -->
