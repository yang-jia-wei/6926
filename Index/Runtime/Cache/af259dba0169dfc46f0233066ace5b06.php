...
<!--                        坏男孩问答-->
                        <div class="xl3 xm3">
                            <div class="cat-box">
                                ...
                                <div class="clear"></div>
                                <div class="cat-site">
                                    <?php $badbody=M()->table('index_badbody n,index_relevance r')->where('r.classify_id =208 and r.content_id=n.badbody_id')->order('date desc')->select();foreach($badbody as $k=>$v){ if($k==0){ ?>
                                            <div class="item">
                                                <a href="<?php echo content_url($v['type_id'],$v['content_id']);?>" data-wpel-link="internal">
...
<!--                        把妹杂谈-->
                        <div class="cat-box">
                            ...
                            <div class="cat-site">
                                <div class="cat-dt">
                                    <?php $gossip=M()->table('index_gossip n,index_relevance r')->where('r.classify_id =209 and r.content_id=n.gossip_id')->order('date desc')->select(); foreach($gossip as $k=>$v){ if($k ==0){ ?>
