...
<nav class="breadcrumb"><a title="返回首页" href="index.php" data-wpel-link="internal">首页</a> &gt; <a href="" data-wpel-link="internal"><?php $classify=M('classify')->where(array('classify_id'=>208))->find();echo $classify['classify_name'];?></a> &gt;  文章 </nav><div id="content" class="site-content" style="transform: none;">
    <div class="clear"></div>
    ...
    <section id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            <div id="post_list_box" class="border_gray">
                <?php $perpage=11;$offset=($p-1)*$perpage; $badbody = M()->table('index_badbody n,index_relevance r')->where('r.classify_id ='.$classify_id.' and r.content_id=n.badbody_id')->order('date desc')->limit($offset,$perpage)->select(); $total_num=M()->table('index_badbody n,index_relevance r')->where('r.classify_id ='.$classify_id.' and r.content_id=n.badbody_id')->count(); foreach($badbody as $k=>$v){ ?>
                    <article id="post-41145" class="archive-list">
                        <figure class="thumbnail box-hide">
                            <a href="http://www.puawm.com/41145" data-wpel-link="internal"><img src="<?php echo $v['badbody_pic'];?>" alt="<?php echo $v['badbody_title'];?>"></a>
                        </figure>
                        <header class="entry-header">
                            <h2 class="entry-title"><a href="<?php echo content_url($v['type_id'],$v['badbody_id'])?>" target="_blank" data-wpel-link="internal"><?php echo $v['badbody_title'];?></a></h2>
                        </header><!-- .entry-header -->
			...
			<span class="entry-meta">
				...
				<span class="date" title="2019/08/29 19:36">4天前</span>
                            ...
                            <div class="archive-content">
                                <?php echo $v['badbody_content'];?>	</div>
