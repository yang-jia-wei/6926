...
<!--            接值（$good_id）-->
<?php $badbody=M('badbody')->where(array('badbody_id'=>$content_id))->find();?>
<nav class="breadcrumb"><a title="返回首页" href=index.php" data-wpel-link="internal">首页</a> &gt; <a href="" rel="category tag" data-wpel-link="internal"><?php $classify=M('classify')->where(array('classify_id'=>208))->find();echo $classify['classify_name'];?></a> &gt;  正文 </nav><div id="content" class="site-content" style="transform: none;">
    <div class="clear"></div>
        ...
        <main id="main" class="site-main" role="main">
            ...
            <article id="post-41151" class="post-41151 post type-post status-publish format-standard hentry category-5">
                <header class="entry-header">
                    <h1 class="entry-title"><?php echo $badbody['badbody_title'];?>></h1>
                    <div class="single_info">
							<span class="xiaoshi">
                            <span class="leixing">
                                            <span class="yclx"><?php echo $badbody['badbody_author'];?></span>
                                    </span>
                ...
                <div class="entry-content">
                    <div class="single-content">
                        <div class="code-block code-block-1" style="">
                            <div class="single_banquan"><span style="font-size: 18px;"><strong><span style="color: #77428D;"><?php echo $badbody['badbody_remarks'];?></span></strong>
                                   <span style="color: #000000;"> <?php echo $badbody['badbody_content'];?>    </span>
                        ...
                        <?php echo $badbody['badbody_content'];?>
