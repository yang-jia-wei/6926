...
<!--            接值（$good_id）-->
<?php $recommended=M('recommended')->where(array('recommended_id'=>$content_id))->find();?>
<nav class="breadcrumb"><a title="返回首页" href="index.php" data-wpel-link="internal">首页</a> &gt; <a href="" rel="category tag" data-wpel-link="internal"><?php $classify=M('classify')->where(array('classify_id'=>207))->find();echo $classify['classify_name'];?></a> &gt;  正文 </nav><div id="content" class="site-content" style="transform: none;">
    <div class="clear"></div>
        ...
        <main id="main" class="site-main" role="main">
            ...
            <article id="post-41151" class="post-41151 post type-post status-publish format-standard hentry category-5">
                <header class="entry-header">
                    <h1 class="entry-title"><?php echo $recommended['recommended_title'];?>></h1>
                    <div class="single_info">
							<span class="xiaoshi">
                            <span class="leixing">
                                            <span class="yclx"><?php echo $recommended['recommended_author'];?></span>
                                    </span>
                        <a href="http://www.puawm.com/41151" rel="nofollow" target="_blank" data-wpel-link="internal"></a>&nbsp;
															</span>
                        <span class="date"><?php echo cover_time($recommended['date'],'Y/m/d')?>&nbsp;</span>
                        <span class="views">  浏览量  <?php echo $recommended['recommended_traffic'];?></span>
                ...
                <div class="entry-content">
                    <div class="single-content">
                        <div class="code-block code-block-1" style="">
                            <div class="single_banquan"><span style="font-size: 18px;"><strong><span style="color: #77428D;"><?php echo $recommended['recommended_remarks'];?></span></strong>
                                   <span style="color: #000000;"> <?php echo $recommended['recommended_content'];?>    </span>
                        ...
                        <?php echo $recommended['recommended_content'];?>
            	...
            	关键词：            </span></span>
                    ...
                    <div class="cat-site">
                        <ul class="cat-one-list">
                            <?php $recommended=M()->table('index_recommended n,index_relevance r')->where('r.classify_id =207 and r.content_id=n.recommended_id')->order('date desc')->select();foreach($recommended as $k=>$v){ ?>
                                <div class="cat-lists"><div class="item-st"><div class="thimg"><a href="<?php echo content_url($v['type_id'],$v['recommended_id'])?>" data-wpel-link="internal"><img src="<?php echo $v['recommended_pic'];?>" alt="<?php echo $v['recommended_title'];?>”"></a></div><p><a href="<?php echo content_url($v['type_id'],$v['recommended_id'])?>" data-wpel-link="internal"><?php echo $v['recommended_title'];?></a></p></div>
                                </div>
                            <?php } ?>
                        </ul>
                        <div class="clear"></div>
