    ...
    <section id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            <div id="post_list_box" class="border_gray">
                ...
                $techniques = M()->table('index_techniques n,index_relevance r')->where('r.classify_id ='.$classify_id.' and r.content_id=n.techniques_id')->order('date desc')->limit($offset,$perpage)->select();
                $total_num=M()->table('index_techniques n,index_relevance r')->where('r.classify_id ='.$classify_id.' and r.content_id=n.techniques_id')->count();            
			...
			<span class="entry-meta">
                ...
                <?php $date1 = date_create(cover_time($v['date']));
