...
<!--            接值（$good_id）-->
<?php $techniques=M('techniques')->where(array('techniques_id'=>$content_id))->find();?>
            ...
            <article id="post-41151" class="post-41151 post type-post status-publish format-standard hentry category-5">
                <header class="entry-header">
                    ...
                    <div class="single_info">
							<span class="xiaoshi">
                            <span class="leixing">
                                            <span class="yclx"><?php echo $techniques['techniques_author'];?></span>
                                    </span>
                ...
                <div class="entry-content">
                    <div class="single-content">
                        <div class="code-block code-block-1" style="">
                            <div class="single_banquan"><span style="font-size: 18px;"><strong><span style="color: #77428D;"><?php echo $techniques['techniques_remarks'];?></span></strong>
                                   <span style="color: #000000;"> <?php echo $techniques['techniques_content'];?>    </span>
...
<!--                                    <strong><span style="color: #77428D;">同时我们将继续传递正确恋爱价值观，坚决抵制不良PUA，还“两性情感”一个真正纯净健康的社交环境！</span></strong></span></div><br></div>-->
                        <?php echo $techniques['techniques_content'];?>
            	...
            	关键词：            </span></span>
                    ...
                    <div class="cat-site">
                        <ul class="cat-one-list">
                            <?php $techniques=M()->table('index_techniques n,index_relevance r')->where('r.classify_id =207 and r.content_id=n.techniques_id')->order('date desc')->select();foreach($techniques as $k=>$v){ ?>
                            <div class="cat-lists"><div class="item-st"><div class="thimg"><a href="<?php echo content_url($v['type_id'],$v['techniques_id'])?>" data-wpel-link="internal"><img src="<?php echo $v['techniques_pic'];?>" alt="<?php echo $v['techniques_title'];?>”"></a></div><p><a href="<?php echo content_url($v['type_id'],$v['techniques_id'])?>" data-wpel-link="internal"><?php echo $v['techniques_title'];?></a></p></div>
                            </div>
                              <?php } ?>
                        </ul>
                        <div class="clear"></div>
