    ...
    <section id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            <div id="post_list_box" class="border_gray">
                ...
                $gossip = M()->table('index_gossip n,index_relevance r')->where('r.classify_id ='.$classify_id.' and r.content_id=n.gossip_id')->order('date desc')->limit($offset,$perpage)->select();
                $total_num=M()->table('index_gossip n,index_relevance r')->where('r.classify_id ='.$classify_id.' and r.content_id=n.gossip_id')->count();
