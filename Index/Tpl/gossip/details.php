            ...
            <article id="post-41151" class="post-41151 post type-post status-publish format-standard hentry category-5">
                <header class="entry-header">
                    ...
                    <div class="single_info">
                        ...
                        <span class="views">  浏览量 <?php echo $gossip['gossip_traffic'];?></span>
            	...
            	关键词：            </span></span>
                    ...
                    <div class="cat-site">
                        <ul class="cat-one-list">
                            <?php $gossip=M()->table('index_gossip n,index_relevance r')->where('r.classify_id =209 and r.content_id=n.gossip_id')->order('date desc')->select();foreach($gossip as $k=>$v){ ?>
