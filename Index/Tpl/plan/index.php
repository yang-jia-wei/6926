    ...
    <section id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            <div id="post_list_box" class="border_gray">
                ...
                $plan = M()->table('index_plan n,index_relevance r')->where('r.classify_id ='.$classify_id.' and r.content_id=n.plan_id')->order('date desc')->limit($offset,$perpage)->select();
                $total_num=M()->table('index_plan n,index_relevance r')->where('r.classify_id ='.$classify_id.' and r.content_id=n.plan_id')->count();
                foreach($plan as $k=>$v){  ?>
