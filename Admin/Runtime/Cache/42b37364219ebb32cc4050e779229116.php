...
<?php $label=M()->table('index_label n,index_relevance r')->where('r.classify_id =217 and r.content_id=n.label_id')->order('date desc')->select(); $valarr=unserialize($list['biaoqian']); foreach($label as $ks=>$vs){?> 
        <label>
